...
export const supers: Array<Super> = [
  ...
  { name: 'Dynaguy', slug: 'dynaguy', threatRating: 6.6, description: 'Flight, disintegration ray', img: 'dynaguy.png' },
  ...
  { name: 'Fironic', slug: 'fironic', threatRating: 6.7, description: 'Fire control, pryotechnic flight', img: 'fironic.png' },
  { name: 'Gazerbeam', slug: 'gazerbeam', threatRating: 7.7, description: 'Lazer vision', img: 'gazerbeam.png' },
  ...
  { name: 'Splashdown', slug: 'splashdown', threatRating: 6.7, description: 'Flight, underwater high-speed travel, aquatic respiration, communication with underwater lifeforms', img: 'splashdown.png' },
  { name: 'Stratogale', slug: 'stratogale', threatRating: 6.8, description: 'Sub-sonic flight, super strength, communication with birds', img: 'stratogale.png' },
  { name: 'Thunderhead', slug: 'thunderhead', threatRating: 7.1, description: 'Storm powers, harness and control extreme weather conditions', img: 'thunderhead.png' },
  { name: 'Plasmabolt', slug: 'plasmabolt', threatRating: 8.2, description: 'Flight, plasma wave emission', img: 'plasmabolt.png' },
  {
    name: 'Metaman',
    slug: 'metaman',
    threatRating: 8.9,
    description: 'Flight, super strength, x-ray vision, sonic scream, teleportation, magnetic manipulation, partial invisibility, communication with aquatic mammals',
    img: 'metaman.png',
  },
  {
    name: 'Mr. Incredible',
